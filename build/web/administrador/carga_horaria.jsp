    ...
    <body>
        <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><img src="/img/favicon.png" alt="logo"
                                                                              style="width: 30px;height: 30px;"> Carga horaria</a>
            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="sidebar-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="carga_horaria.jsp">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Carga horaria semanal</h1>
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Jacinto Dario Pérez Flórez</td>
                                    <td>jdpf@email.com</td>
                                    <td>No registrado</td>
                                    <td>48hrs</td>
                                </tr>
                                <tr>
                    ...
                    <script>
                        ...
                        var myChart = new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: ['Menos de 48 hrs', '48 hrs', 'Más de 48hrs'],
                                datasets: [{
                                        label: 'Carga horaria de profesores',
                                        data: [12, 19, 3],
                                        backgroundColor: [
                                            'rgba(255, 99, 132, 1)',
                                            'rgba(54, 162, 235, 1)',
