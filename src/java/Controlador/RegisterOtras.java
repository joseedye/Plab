...
public class RegisterOtras extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            //get data vista
            String nombre = req.getParameter("onombre");
            int hsemana = Integer.valueOf(req.getParameter("ohsemana"));
            int hsemestre = Integer.valueOf(req.getParameter("ohsemestre"));
            ...
            Otras otra = new Otras(auto_increment, hsemestre);
