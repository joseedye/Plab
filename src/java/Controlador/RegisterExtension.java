...
public class RegisterExtension extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            ExtensionJpaController extensionDao = new ExtensionJpaController(emf);
            ...
            //get data vista
            String nombre = req.getParameter("enombre");
            String codigo = req.getParameter("ecodigo");
            String responsabilidades = req.getParameter("eresponsabilidades");
            String unidad = req.getParameter("eunidad");
            String programa = req.getParameter("eprograma");
            int hejecucion = Integer.valueOf(req.getParameter("ehejecucion"));
            int hprogramacion = Integer.valueOf(req.getParameter("ehprogramacion"));
            int hsemana = Integer.valueOf(req.getParameter("ehsemana"));
            int hsemestre = Integer.valueOf(req.getParameter("ehsemestre"));
            ...
            Extension extension = new Extension(auto_increment, responsabilidades, codigo, unidad, hsemestre, hejecucion, hprogramacion, programa);
