...
public class AdministradorJpaController implements Serializable {
    ...
    public void create(Administrador administrador) {
        ...
        try {
            ...
            if (idUsuario != null) {
                idUsuario.getAdministradorList().add(administrador);
    ...
    public void edit(Administrador administrador) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idUsuarioOld != null && !idUsuarioOld.equals(idUsuarioNew)) {
                idUsuarioOld.getAdministradorList().remove(administrador);
                idUsuarioOld = em.merge(idUsuarioOld);
            }
            if (idUsuarioNew != null && !idUsuarioNew.equals(idUsuarioOld)) {
                idUsuarioNew.getAdministradorList().add(administrador);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Usuario idUsuario = administrador.getIdUsuario();
            if (idUsuario != null) {
                idUsuario.getAdministradorList().remove(administrador);
                idUsuario = em.merge(idUsuario);
            }
