    ...
    <body>
                ...
                <main role="main" class="col-12">
                    ...
                    <div class="container">
                        ...
                        <div class="mx-auto" style="max-width: 500px;">
                            <form name="form1" method="post" action="../PassChange.do">
                                <h3 style="color: #007DFF; font-weight: bold;"> Ingresar Nueva Contraseña </h3>
                                <br>
                                <label for="pass">Contraseña</label>
                                <div class="input-group">                                    
                                    <input id="pass" onKeyUp="hidelabel()" name="pass" type="password" class="form-control" required>
                                ...
                                <p id="labelno" style="color:red; display:none;" ></p>
                                <label for="pass">Repetir contraseña</label>
                                <div class="input-group">                                    
                                    <input id="pass2" onKeyUp="hidelabel()" name="pass2" type="password" class="form-control" required>
                                    <div class="input-group-append">
                                        <button id="show_password" class="btn btn-primary" type="button" onclick="togglePassword2('pass2')"> 
                                            <span id="eye2" class="fa fa-eye icon"></span> 
                                        </button>
                                    </div>
                                </div>  
                                <p id="labelno2" style="color:red; display:none;" ></p>
                                <br>
                                <a href="/"><u>Regresar</u></a>
                                <hr>
                                <div style="display: flex; justify-content: center;">
                                    <button type="button" onclick="comprobarClave()" class="btn btn-primary">Aceptar</button>
                                </div>
        ...
        <script>
            ...
            function comprobarClave(){  
                ...
                if(cl1==="" || cl2===""){
                    $("#labelno2").text("Completar todos los campos.");
                    $("#labelno2").show();
                }
                else if(cl1 !== cl2){
                    $("#labelno").text("Contraseñas no coinciden.");
                    $("#labelno2").text("Contraseñas no coinciden.");
                    $("#labelno").show();
                    $("#labelno2").show();
                }               
                else{
