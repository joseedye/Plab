            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card p-4 col-5">
                        <p style="font-size:20px">Cambio de contraseña</p><hr>
                        <form method="post" action="../UpdatePassword.do">
                            Ingresar contraseña anterior<br>
                            <div class="input-group">                                
                                <input id="oldPassword" name="oldPassword" type="password" class="form-control" required>
                                <div class="input-group-append">
                                    <button id="show_password" class="btn btn-primary" type="button" onclick="togglePassword1('oldPassword')"> <span id="eye1" class="fa fa-eye icon"></span> </button>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button id="show_password" class="btn btn-primary" type="button" onclick="togglePassword2('newPassword')"> <span id="eye2" class="fa fa-eye icon"></span> </button>
                                </div>
                            </div>
                            <br>
