 ...
 */
    ...
    <body>
        <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#"><img src="/img/favicon.png" alt="logo" style="width: 30px;height: 30px;"> Actividades</a>
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" href="../QueryActivity.do">
                                    <i class="fas fa-business-time"></i> Mis actividades
                                </a>
                            </li>
                            <li class="nav-item">
