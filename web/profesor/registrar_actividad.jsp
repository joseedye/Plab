                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div id="divdocencia" style="display:none" class="card p-4">
                        ...
                        <form method="post" action="../RegisterDocencia.do">
                            <div class="form-group">
                                Código
                                <input name="dcodigo" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                Grupo
                                <input name="dgrupo" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                Nombre
                                <input name="dnombre" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                Créditos
                                <input name="dcreditos" type="number" class="form-control">
                            </div>
                            <div class="form-group">
                                # de estudiantes
                                <input name="dnestudiantes" type="number" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="dht" type="number" class="form-control">
                            </div>
                            <div class="form-group">
                                Horas semanal Teóricas Prácticas
                                <input name="dhtp"type="number" class="form-control">
                            </div>
                            <div class="form-group">
                                Horas semanal Prácticas
                                <input name="dhp" ype="number" class="form-control">
                            </div>
                            <div class="form-group">
                                Horas semana
                                <input name="dhsemana" type="number" class="form-control">
                            </div>
                            <div class="form-group">
                                Horas semestre
                                <input name="dhsemestre" type="number" class="form-control">
                            </div>
                            <button type="submit" class="btn btn-primary">Registrar</button>
                        </form>
                    </div>
